...
FSMarkovChainState::FSMarkovChainState(int stateID, int numTransitions, ...)
{
    ...
    _transitions = new FSMarkovChainStateTransition[_numTransitions];
...
FSMarkovChainState::~FSMarkovChainState()
{
    delete [] _transitions;
}

int FSMarkovChainState::stateID()
{
    return _stateID;
}

int FSMarkovChainState::nextStateID()
{
    double randomValue = ((double)arc4random() / ARC4_RANDOM_MAX) * _stateChangeFactorTotal;
